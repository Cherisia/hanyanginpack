    ...
    return (
        <section className="mx-auto">
            <div className="flex items-center relative justify-center w-full h-[50rem]">
                <Image className="brightness-50 mx-auto object-cover" src={MainImage} alt="한양인팩 메인 이미지" fill priority/>
                <div className="container mx-auto absolute px-4 text-slate-100 space-y-8">
                    <div className="text-3xl lg:text-5xl font-black font-nanumEB space-y-3">
                        <div>제품의 가치는</div>
                        <div>포장에서 시작됩니다.</div>
                    </div>
