...
import MainImage from "/public/img/inquiry/inquiry_main.webp"
...
export default function Banner() {
    ...
    return (
        <div className="relative h-[24rem] mx-auto">
            <Image className="brightness-[60%] object-cover" src={MainImage} fill={true} priority placeholder="blur"
                   sizes="100vw" alt="한양인팩 견적문의 메인 이미지"/>
            <div
