...
import MainImage from "/public/img/faq/faq_main.webp"
...
export default function Banner() {
    ...
    return (
        <div className="relative h-[24rem] mx-auto">
            <Image className="brightness-[70%] object-cover" src={MainImage} fill={true} priority placeholder="blur"
                   sizes="100vw" alt="한양인팩 자주묻는질문 메인 이미지"/>
            <div
